...
/*   Updated: 2022/07/08 23:00:57 by odessein         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_apply_rules_before(char *str, int size, t_useful *sign,
				int *r_v);
...
void		ft_manage_hexa(char *str, unsigned int val, int *r_v,
				t_bool *not_end);
...
void		ft_manage_unsigned(char *str, unsigned int val, int *r_v,
				t_bool *n_en);
...
void		ft_manage_hexa_v1(int *i, t_useful *sign, t_bool *not_end,
				char *str);
